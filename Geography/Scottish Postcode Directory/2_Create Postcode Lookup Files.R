...
# Codename - Create Postcode Lookup Files
...
# Read in packages from install.packages
...
# There has previously been issues when comparing Latitude/Longitude between 
...
SPD %<>% 
  mutate(Locality_2001 = str_pad(SPD$Locality_2001, 6, pad = "0"), 
         Settlement_2001 = str_pad(SPD$Settlement_2001, 3, pad = "0"), 
         Locality_1991 = str_pad(SPD$Locality_1991, 3, pad = "0"), 
         Islands_2016 = str_pad(SPD$Islands_2016, 3, pad = "0"))
...
# original file - contact NRS if this happens
...
SPD %<>%
  ...
  select(pc7, pc8:CA2019, CA2019Name, CA2018, CA2011, UPC2005:HB2019, 
         ...
         HHC2011:TTWA_2011, UR2_2016, UR2_2016_name, UR3_2016, UR3_2016_name, 
         UR6_2016, UR6_2016_name, UR8_2016, UR8_2016_name, 
         Gridlink_Ind:NeverDigitised)



### 5 - Save file as .RDS ----

saveRDS(SPD, glue("{output_filepath}/Scottish_Postcode_Directory_2019_2.rds"))
