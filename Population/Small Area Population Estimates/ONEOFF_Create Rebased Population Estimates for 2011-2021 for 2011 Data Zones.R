...
saveRDS(dz2011_pop_final, 
        glue("{lookup_filepath},
             /DataZone2011_pop_est_2011_2022_REBASED_v2.rds"))

fwrite(dz2011_pop_final, 
       glue("{lookup_filepath},
            /DataZone2011_pop_est_2011_2022_REBASED_v2.csv", 
            na = ""))

write_parquet(dz2011_pop_final,
              sink = glue("{lookup_filepath}",
                          "/DataZone2011_pop_est_2011_2022.parquet"),
              compression = "zstd")
...
saveRDS(dz2011_pop_final_5y, 
        glue("{lookup_filepath}/DataZone2011_pop_est_5year_agegroups_2011_2022_REBASED_v2.rds"))

fwrite(dz2011_pop_final_5y, 
       glue("{lookup_filepath}/DataZone2011_pop_est_5year_agegroups_2011_2022_REBASED_v2.csv", na = ""))

write_parquet(dz2011_pop_final_5y, 
              sink = glue("{lookup_filepath}",
                          "/DataZone2011_pop_est_5year_agegroups_2011_2022.parquet"),
              compression = "zstd")
...
write_parquet(iz2011_pop_final, 
              sink = glue("{lookup_filepath}",
                          "/IntZone2011_pop_est_2011_2022.parquet"),
              compression = "zstd")
...
write_parquet(iz2011_pop_final_5y, 
              sink = glue("{lookup_filepath}",
                          "/IntZone2011_pop_est_5year_agegroups_2011_2022.parquet"),
              compression = "zstd")
